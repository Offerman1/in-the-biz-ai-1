...
## 🌐 WEB DEPLOYMENT TO GITHUB PAGES (UPDATED - January 1, 2026)

**AUTOMATED DEPLOYMENT WITH GITHUB ACTIONS**

The repository now uses GitHub Actions for automated deployments. Manual builds are no longer needed.

### Repository Structure:
- **`main` branch:** Source code only (lib/, pubspec.yaml, etc.)
- **`gh-pages` branch:** Built files only (auto-generated by GitHub Actions)
- GitHub Pages serves from `gh-pages` branch at `https://inthebiz.app/`
...
- **Flutter Version:** 3.38.5 (matches local version)
- **Trigger:** Pushes to `main` branch
- **Output:** Deploys `build/web/` to `gh-pages` branch

### Important Notes:
- **Never manually edit `gh-pages` branch** - it's auto-generated
- All code changes go to `main` branch
- Check deployment status: https://github.com/munzer221/in-the-biz-ai/actions
