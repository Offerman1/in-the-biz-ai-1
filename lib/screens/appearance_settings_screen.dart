...
class _AppearanceSettingsScreenState extends State<AppearanceSettingsScreen> {
  ...
  Widget _buildThemeSelector() {
    ...
    final themeIcons = {
      ...
      'cash_light': Icons.light_mode,
      'light_blue': Icons.wb_sunny,
      'purple_light': Icons.palette,
      'sunset_light': Icons.wb_twilight,
      'ocean_light': Icons.water,
      'pink_light': Icons.favorite,
      'slate_light': Icons.invert_colors,
      'mint_light': Icons.eco,
      'lavender_light': Icons.spa,
      'gold_light': Icons.star,
    };
